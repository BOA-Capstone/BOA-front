...
const AboutSection: React.FC<AboutSectionProps> = ({ className }) => {
  ...
  return (
  <section ref={ref} className={`min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0a0a23] via-[#101d32] to-[#2ee9d9] text-white px-4 ${className || ''}`}>
