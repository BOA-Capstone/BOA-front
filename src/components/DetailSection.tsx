...
const DetailSection: React.FC<DetailSectionProps> = ({ className }) => {
  ...
  return (
  <section ref={ref} className={`relative flex flex-col min-h-screen w-screen items-center justify-center bg-gradient-to-br from-[#181c2b] via-[#38bdf8] to-[#7ef26a] ${inView ? 'animate-fade-in' : ''} ${className || ''}`}>
